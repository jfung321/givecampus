...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference('Fund.count') do
      post funds_url, params: { fund: { donations_id: @fund.donations_id, name: @fund.name, total: @fund.total } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { donations_id: @fund.donations_id, name: @fund.name, total: @fund.total } }
